...
PRODUCE (write as dated Markdown under `growth/`):
1. `growth/ideas/<date>-<topic>.md` — 3–5 transferable ideas from peer developer / creative-coder portfolios and dev-tool launch pages (use WebSearch / WebFetch). Each: source URL, the insight, and how it could apply here within this repo's constraints (small semantic vocabulary, generative aesthetic, minimal deps). Discard ideas that don't fit.
2. `growth/posts/<date>-<topic>.md` — a few social post drafts (LinkedIn + X, optionally Bluesky), grouped by platform, promoting the library, HDD dev work, and any career angle. Each: hook, substance, link. Real and specific, no hype.
